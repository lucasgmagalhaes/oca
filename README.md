...
crates/
  ...
  nivela-core/   UI-agnostic engine: project/timeline/media data model, media wrappers
                 ...
                 now), a minimal GStreamer preview pipeline (open/play/pause/seek, no frame
                 display yet), mock sample data. No egui dependency.
...
(open/play/pause/seek/query) but isn't wired into the Editor screen — no frame extraction or
texture upload yet. Not yet implemented: that frame display, real timeline editing
