...
## Corpus Check
- 361 files · ~696,404 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5648 nodes · 11170 edges · 355 communities (306 shown, 49 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 663 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0d957d18`
...
- icon_label_job
- SilenceReview
- pump_voice_cleanup_preview_stores_a_successful_result_and_clears_rendering

## God Nodes (most connected - your core abstractions)
1. `test_app()` - 357 edges
2. `ClipInstance` - 103 edges
3. `App` - 98 edges
4. `clip()` - 75 edges
5. `Project` - 66 edges
6. `MediaAsset` - 59 edges
7. `oca Design System` - 58 edges
8. `track_with()` - 57 edges
9. `Locale` - 56 edges
...
## Communities (355 total, 49 thin omitted)
...
Cohesion: 0.01
Nodes (253): a_continuous_effect_property_drag_pushes_only_one_undo_step(), add_asset_to_new_track_gives_each_call_its_own_track(), add_asset_to_new_track_is_a_no_op_for_an_unknown_asset_id(), add_asset_to_timeline_creates_a_track_and_appends_a_clip_when_none_exists(), add_asset_to_timeline_creates_an_audio_track_for_an_audio_asset(), add_asset_to_timeline_is_a_no_op_for_an_unknown_asset_id(), add_asset_to_timeline_leaves_voice_cleanup_off_for_a_non_mic_role_track(), add_marker_at_playhead_places_it_at_the_current_playhead() (+245 more)

### Community 3 - "avbridge/src/lib.rs"
Cohesion: 0.11
Nodes (25): c_char, c_int, c_longlong, AudioMixError, AudioMixOutcome, EncodeError, LoudnessError, MatteError (+17 more)
...
### Community 5 - "Preview"
Cohesion: 0.06
Nodes (67): AppSink, AppSrc, AtomicI32, BoolError, FrameSampler, Duration, Option, Path (+59 more)
...
Cohesion: 0.09
Nodes (22): add_and_open_project_appends_and_opens_it(), add_asset_to_new_track_always_creates_a_fresh_track_even_when_a_matching_one_exists(), add_asset_to_timeline_appends_after_whatever_is_already_on_the_matching_track(), add_asset_to_timeline_defaults_voice_cleanup_on_for_a_mic_role_track(), confirm_apply_layer_template_puts_each_layer_on_its_own_new_track(), confirm_apply_layer_template_skips_layers_left_without_an_asset(), load_panel_layout_applies_the_active_projects_saved_layout(), load_panel_layout_is_a_no_op_under_per_user_scope() (+14 more)
...
### Community 51 - "Path"
Cohesion: 0.17
Nodes (18): apply_shape_overlays(), encode_matte_video(), generate_proxy(), generate_waveform(), measure_loudness_json(), mux_video_audio(), remux_copy(), Path (+10 more)
...
Cohesion: 0.05
Nodes (59): approx(), main_subject_picks_highest_score(), nms_collapses_overlapping_boxes(), no_subject_falls_back_to_center_crop(), same_aspect_ratio_keeps_full_frame(), subject_near_edge_clamps_without_overflow(), subject_off_center_shifts_crop_toward_it(), wider_target_keeps_full_width() (+51 more)
...
Cohesion: 0.23
Nodes (27): Canvas, ShapeSegment, apply_audio_mix_pass(), apply_export_aspect_ratio(), apply_shape_overlay_pass(), apply_text_overlay_pass(), fps_to_rational(), render_export() (+19 more)
...
Cohesion: 0.06
Nodes (53): AudioRole, color_filter_tint(), draw_filmstrip(), draw_frozen_poster(), draw_keyframe_markers(), draw_marker_ticks(), draw_playhead(), draw_ruler_ticks() (+45 more)
...
Cohesion: 0.11
Nodes (41): AutoReframeEvent, AutoReframeState, AvailableUpdate, BindableAction, DynamicReframeEvent, DynamicReframeState, MatteGenerationEvent, MatteGenerationState (+33 more)
...
### Community 102 - "detect_subject_at"
Cohesion: 0.14
Nodes (15): App, auto_reframe_one(), downscale_frame_rgba(), extract_frame(), Option, Path, UnboundedSender, Vec (+7 more)

### Community 103 - "test_asset"
Cohesion: 0.10
Nodes (26): apply_silence_review_ripple_deletes_only_accepted_gaps_and_closes_the_modal(), detach_audio_is_a_no_op_when_the_asset_has_no_audio(), ensure_preview_loaded_clears_state_once_the_playhead_moves_past_every_clip(), ensure_preview_loaded_resolves_the_clip_covering_the_playhead(), import_gameplay_events_adds_a_marker_for_a_matching_clip(), import_gameplay_events_is_idempotent(), import_gameplay_events_toasts_on_invalid_json(), import_gameplay_events_toasts_when_no_clip_uses_the_recording() (+18 more)
...
Cohesion: 0.11
Nodes (18): primary_button(), Response, Ui, card_frame(), panel_frame(), Frame, modal_title(), page_title() (+10 more)
...
Cohesion: 0.18
Nodes (20): ColorFilter, color_filter_label(), f32_keyframe_editor(), mask_shape_label(), polygon_vertex_editor(), position_keyframe_editor(), Option, String (+12 more)

### Community 141 - "editor/mod.rs"
Cohesion: 0.22
Nodes (21): audio_meter_column(), resizable_divider(), resizable_divider_horizontal(), App, Ui, audio_level_meter(), draw_custom_shape_surface(), draw_meter_bar() (+13 more)
...
Cohesion: 0.15
Nodes (12): family(), install(), Context, FontFamily, open_in_finder(), App, PathBuf, Ui (+4 more)
...
### Community 156 - "clip.rs"
Cohesion: 0.10
Nodes (6): ClipFormatting, LayerTemplate, MaskShape, String, Vec, TransitionType
...
Cohesion: 0.20
Nodes (10): collab_bundle_scratch_dir(), export_collab_bundle_writes_a_zip_and_toasts_success(), import_collab_bundle_opens_the_project_with_its_new_file_path(), PathBuf, shorts_pack_scratch_dir(), spawn_shorts_pack_defers_export_and_starts_reframing_an_un_reframed_clip(), spawn_shorts_pack_queues_one_job_per_highlight_marker(), spawn_shorts_pack_skips_the_reframe_pre_pass_when_no_model_is_configured() (+2 more)
...
Cohesion: 0.09
Nodes (4): ClipInstance, Option, clip(), clip()
...
### Community 207 - "PathBuf"
Cohesion: 0.13
Nodes (15): LoudnessMetrics, ImportEvent, PathBuf, ShortsPackReframeState, WatchedFileRow, WatchFolderEvent, WatchFolderFileStatus, App (+7 more)

### Community 208 - "Vec"
Cohesion: 0.23
Nodes (13): ImportState, NestedSequenceEvent, NestedSequenceRenderState, PendingGraphicTemplateApply, PreviewState, HashMap, HashSet, Instant (+5 more)
...
Cohesion: 0.25
Nodes (15): Recency, Screen, delete_sequence_prompt(), delete_track_prompt(), job_detail_line(), job_status_label(), Locale, media_item_count_label() (+7 more)
...
Cohesion: 0.22
Nodes (7): text_clip(), Option, String, Vec, TextClip, WordTiming, text_clip()
...
### Community 245 - "text_clip.rs"
Cohesion: 0.27
Nodes (15): family_matches_search(), font_category_label(), font_family_category(), font_family_picker_body(), App, Response, String, TextFontFamily (+7 more)
...
Cohesion: 0.17
Nodes (5): marker_color_name(), MarkerKind, App, String, marker_kind_icon()
...
### Community 261 - "minimal_graphic_template"
Cohesion: 0.18
Nodes (11): apply_graphic_template_places_a_shape_element_on_its_own_track(), apply_graphic_template_places_a_text_element_at_the_playhead(), apply_graphic_template_places_text_and_shape_elements_on_separate_tracks(), apply_graphic_template_pushes_exactly_one_undo_snapshot_for_the_whole_batch(), apply_graphic_template_resolves_a_parameter_bound_text_value(), apply_graphic_template_toasts_and_makes_no_change_on_a_missing_parameter_value(), cancel_apply_graphic_template_discards_the_staged_template_without_applying(), confirm_apply_graphic_template_applies_the_staged_template_with_filled_values() (+3 more)
...
### Community 346 - "toolbar.rs"
Cohesion: 0.40
Nodes (10): EditorTool, export_srt_for_active_sequence(), App, Ui, save_active_project(), sequence_tab_bar(), SequenceTabDrag, tool_button() (+2 more)

### Community 347 - "media_library_panel.rs"
Cohesion: 0.42
Nodes (9): asset_thumb(), asset_thumb_sized(), media_filter_tab(), media_library_panel(), App, Option, TextureHandle, Ui (+1 more)

### Community 348 - "EffectPreset"
Cohesion: 0.25
...
### Community 353 - "SilenceReview"
Cohesion: 0.67
Nodes (3): Vec, SilenceReview, SilenceReviewGap

## Knowledge Gaps
- **892 isolated node(s):** `OpenControlKind`, `App`, `MatchingClip`, `App`, `App` (+887 more)
...
- **Why does `ClipInstance` connect `ClipInstance` to `shorts_pack_test.rs`, `timeline_test.rs`, `Preview`, `properties_panel`, `track_with`, `interchange_test.rs`, `src/highlight_detection.rs`, `timeline_window_test.rs`, `project_test.rs`, `transcript_proposals_test.rs`, `interchange.rs`, `Track`, `clip.rs`, `Timeline`, `timeline_export_multi_test.rs`, `timeline_with`, `Keyframe`, `App`, `App`, `probe_media`, `render.rs`, `App`, `silence_detection.rs`, `Position`, `preview_test.rs`, `draw.rs`, `App`, `timeline_ops.rs`, `test_track`, `blend_channel`, `nested_sequence_test.rs`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `persistence_test.rs`, `app_test.rs`, `src/collab_bundle.rs`, `ensure_proxy`, `interchange_test.rs`, `MediaAsset`, `project_test.rs`, `interchange.rs`, `test_project`, `Timeline`, `src/background_removal.rs`, `persistence.rs`, `SmartBin`, `transcript.rs`, `App`, `Sequence`, `Locale`, `TIMELINE.md`, `tests/background_removal_test.rs`, `test_asset`, `PrefsState`, `test_track`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `App` connect `App` to `ErrorReport`, `MediaAsset`, `LibraryTrack`, `transcript_proposals_test.rs`, `clip.rs`, `Project`, `SmartBin`, `ClipInstance`, `Sequence`, `PathBuf`, `Vec`, `ExportJob`, `Locale`, `crash_review_test.rs`, `toolbar.rs`, `app/mod.rs`, `SilenceReview`, `App`, `PrefsState`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **What connects `OpenControlKind`, `App`, `MatchingClip` to the rest of the system?**
...
- **Should `app_test.rs` be split into smaller, more focused modules?**
  _Cohesion score 0.014426011207901015 - nodes in this community are weakly interconnected._
