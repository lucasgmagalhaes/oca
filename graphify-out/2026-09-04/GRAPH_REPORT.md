...
## Corpus Check
- 342 files · ~668,672 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5352 nodes · 10570 edges · 339 communities (292 shown, 47 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 599 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19f17738`
...
## Communities (339 total, 47 thin omitted)
...
### Community 43 - "TextLayoutEngine"
Cohesion: 0.21
Nodes (8): FnOnce, Self, SwashCache, with_shared_engine_reuses_the_same_engine_across_calls(), TextLayoutEngine, with_shared_engine(), FontSystem, R
...
Cohesion: 0.18
Nodes (33): Canvas, ClipSegment, apply_audio_mix_pass(), apply_export_aspect_ratio(), apply_shape_overlay_pass(), apply_text_overlay_pass(), clip_segment_duration_secs(), fps_to_rational() (+25 more)
...
### Community 68 - "App"
Cohesion: 0.13
Nodes (4): App, BindableAction, MediaLibraryFilter, Pos2
...
Cohesion: 0.20
Nodes (20): resolve_shape_segments(), resolve_text_segments(), shape_clip_to_segment(), cancelling_mid_render_reports_cancelled(), fixture(), rejects_a_missing_source(), renders_and_normalizes_loudness_toward_target(), resolve_shape_segments_returns_empty_when_no_shape_track_exists() (+12 more)
...
Cohesion: 0.07
Nodes (46): AudioRole, color_filter_tint(), draw_filmstrip(), draw_frozen_poster(), draw_keyframe_markers(), draw_marker_ticks(), draw_playhead(), draw_ruler_ticks() (+38 more)
...
Cohesion: 0.09
Nodes (34): Box, Condvar, AudioSegment, PathBuf, String, ShapeSegment, TextOverlaySegment, ExportJob (+26 more)
...
Cohesion: 0.14
Nodes (23): AutoReframeEvent, AvailableUpdate, MatteGenerationEvent, MediaViewMode, MotionTrackRegionState, PendingGraphicTemplateApply, prefs_path(), PropertiesTab (+15 more)
...
Cohesion: 0.07
Nodes (28): primary_button(), Response, Ui, card_frame(), panel_frame(), Frame, icon_button(), IconButtonOpts (+20 more)
...
Cohesion: 0.26
Nodes (18): AutoReframeState, DynamicReframeState, MatteGenerationState, MotionTrackingState, Arc, AtomicBool, Option, UnboundedReceiver (+10 more)
...
### Community 171 - "i18n_test.rs"
Cohesion: 0.12
Nodes (7): ExportJobStatus, String, ocqueue_file_atomically_replaces_the_previous_snapshot(), test_job(), job(), job_detail_line_flips_the_negative_lufs_sign_for_display(), job_detail_line_shows_translated_error_prefix_on_failure()
...
Cohesion: 0.06
Nodes (24): export_srt(), exports_two_clips_as_sequential_numbered_entries(), format_srt_timestamp(), ignores_non_text_tracks(), orders_entries_by_start_time_regardless_of_input_order(), returns_an_empty_string_for_a_timeline_with_no_text_clips(), String, Vec (+16 more)
...
Cohesion: 0.17
Nodes (9): WatchFolderEvent, App, Arc, AtomicBool, Option, Path, PathBuf, UnboundedSender (+1 more)

### Community 208 - "Vec"
Cohesion: 0.17
Nodes (17): DynamicReframeEvent, ImportEvent, ImportState, MotionTrackEvent, NestedSequenceEvent, NestedSequenceRenderState, PreviewState, HashMap (+9 more)
...
Cohesion: 0.14
Nodes (18): Recency, App, EffectCategory, EffectPreset, Screen, delete_sequence_prompt(), delete_track_prompt(), job_detail_line() (+10 more)
...
### Community 238 - "TranscribeSegment"
Cohesion: 0.24
...
Cohesion: 0.15
Nodes (20): OpenControlKind, resolve_paragraph_direction(), resolve_text_align(), ResolvedDirection, Option, Range, String, TextFontFamily (+12 more)
...
### Community 254 - "FrameSampler"
Cohesion: 0.24
Nodes (7): FrameSampler, Duration, Option, Path, Result, Self, Vec
...
- **Why does `ClipInstance` connect `ClipInstance` to `shorts_pack_test.rs`, `timeline_test.rs`, `Preview`, `properties_panel`, `track_with`, `interchange_test.rs`, `src/highlight_detection.rs`, `timeline_window_test.rs`, `project_test.rs`, `transcript_proposals_test.rs`, `interchange.rs`, `timeline_export_multi_test.rs`, `timeline_with`, `Keyframe`, `App`, `App`, `next_clip_id`, `probe_media`, `render.rs`, `App`, `silence_detection.rs`, `Timeline`, `Position`, `preview_test.rs`, `draw.rs`, `App`, `test_track`, `blend_channel`, `nested_sequence_test.rs`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `App` connect `App` to `ErrorReport`, `Sequence`, `editor/mod.rs`, `LibraryTrack`, `transcript_proposals_test.rs`, `interchange.rs`, `Option`, `MediaAsset`, `Project`, `ClipInstance`, `SmartBin`, `silence_detection.rs`, `Timeline`, `Vec`, `ExportJob`, `Locale`, `crash_review_test.rs`, `app/mod.rs`, `App`, `PrefsState`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `persistence_test.rs`, `app_test.rs`, `Sequence`, `ensure_proxy`, `interchange_test.rs`, `persistence.rs`, `tests/background_removal_test.rs`, `project_test.rs`, `interchange.rs`, `test_project_with_tracks_and_assets`, `MediaAsset`, `test_project`, `src/background_removal.rs`, `CollabBundleError`, `SmartBin`, `transcript.rs`, `App`, `parsing.rs`, `Locale`, `test_asset`, `PrefsState`?**
