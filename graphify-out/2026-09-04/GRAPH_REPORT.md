...
## Corpus Check
- 339 files · ~640,006 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5253 nodes · 10333 edges · 335 communities (289 shown, 46 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 587 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46c7a905`
...
Cohesion: 0.25
Nodes (13): Arc, AtomicBool, FnMut, Option, transcribe(), cancelling_before_the_call_skips_inference_entirely(), fails_on_a_missing_model_file(), fails_on_a_source_with_no_audio_stream() (+5 more)
...
Cohesion: 0.18
Nodes (32): Canvas, GpuEncoderPreference, apply_audio_mix_pass(), apply_export_aspect_ratio(), apply_shape_overlay_pass(), apply_text_overlay_pass(), fps_to_rational(), render_export() (+24 more)
...
Cohesion: 0.18
Nodes (21): resolve_shape_segments(), resolve_text_segments(), shape_clip_to_segment(), WordTiming, cancelling_mid_render_reports_cancelled(), fixture(), rejects_a_missing_source(), renders_and_normalizes_loudness_toward_target() (+13 more)
...
Cohesion: 0.07
Nodes (45): AudioRole, color_filter_tint(), draw_filmstrip(), draw_frozen_poster(), draw_keyframe_markers(), draw_marker_ticks(), draw_playhead(), draw_ruler_ticks() (+37 more)
...
Cohesion: 0.09
Nodes (35): Box, Condvar, AudioSegment, ClipSegment, PathBuf, String, ShapeSegment, ExportJob (+27 more)
...
Cohesion: 0.08
Nodes (31): apply_silence_review_ripple_deletes_only_accepted_gaps_and_closes_the_modal(), collab_bundle_scratch_dir(), detach_audio_is_a_no_op_when_the_asset_has_no_audio(), detect_highlights_toasts_when_a_role_is_missing(), detect_highlights_toasts_when_nothing_spikes_together(), ensure_preview_loaded_clears_state_once_the_playhead_moves_past_every_clip(), ensure_preview_loaded_resolves_the_clip_covering_the_playhead(), export_collab_bundle_writes_a_zip_and_toasts_success() (+23 more)
...
Cohesion: 0.06
Nodes (36): primary_button(), Response, Ui, card_frame(), panel_frame(), Frame, modal_title(), page_title() (+28 more)
...
Cohesion: 0.06
Nodes (84): clip_instance_from_interchange(), clip_omitted_effects(), clip_to_interchange(), CompatibilityReportEntry, entry(), ImportWarning, interchange_compatibility_report(), clip() (+76 more)
...
### Community 192 - "process_watched_file"
Cohesion: 0.18
...
Cohesion: 0.07
Nodes (34): face_bytes(), find_family(), assert_face_matches(), bundled_anonymous_pro_bytes_match_the_locked_manifest(), bundled_archivo_black_bytes_match_the_locked_manifest(), bundled_barlow_bytes_match_the_locked_manifest(), bundled_bebas_neue_bytes_match_the_locked_manifest(), bundled_fredoka_bytes_match_the_locked_manifest() (+26 more)
...
Cohesion: 0.07
Nodes (13): ClipFormatting, LayerTemplate, Marker, MaskShape, MulticamGroup, HashMap, String, Vec (+5 more)
...
### Community 332 - "icon_label_job"
Cohesion: 0.40
Nodes (4): icon_label_job(), Color32, FontFamily, LayoutJob

### Community 334 - "parsing.rs"
Cohesion: 0.67
...
- **Why does `ClipInstance` connect `ClipInstance` to `shorts_pack_test.rs`, `persistence_test.rs`, `timeline_test.rs`, `Preview`, `properties_panel`, `track_with`, `src/highlight_detection.rs`, `timeline_window_test.rs`, `project_test.rs`, `transcript_proposals_test.rs`, `interchange_test.rs`, `Track`, `timeline_export_multi_test.rs`, `timeline_with`, `Keyframe`, `App`, `App`, `next_clip_id`, `probe_media`, `render.rs`, `App`, `silence_detection.rs`, `Timeline`, `Position`, `preview_test.rs`, `draw.rs`, `App`, `test_track`, `blend_channel`, `nested_sequence_test.rs`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `App` connect `App` to `app/mod.rs`, `Vec`, `App`, `silence_detection.rs`, `ErrorReport`, `Project`, `Timeline`, `Sequence`, `ClipInstance`, `PrefsState`, `MediaAsset`, `editor/mod.rs`, `LibraryTrack`, `ExportJob`, `Locale`, `crash_review_test.rs`, `transcript_proposals_test.rs`, `SmartBin`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `Keyframe` connect `Keyframe` to `app/mod.rs`, `shorts_pack_test.rs`, `Preview`, `Timeline`, `Position`, `TextClip`, `properties_panel`, `ClipInstance`, `track_region`, `split_keyframes_at`, `dynamic_reframe_test.rs`, `keyframe.rs`, `shape_render_test.rs`?**
