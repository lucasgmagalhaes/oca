...
## Corpus Check
- 67 files · ~51,917 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 681 nodes · 1194 edges · 34 communities (32 shown, 2 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 50 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7ea7d929`
...
### Community 0 - "OcaApp"
Cohesion: 0.05
Nodes (45): Arc, TrackKind, EditorTool, extract_thumbnail(), import_one(), next_clip_id(), OcaApp, PrefsState (+37 more)
...
Cohesion: 0.07
Nodes (30): ClipInstance, Option, String, Vec, Track, clip(), clip_mut_finds_a_clip_by_id(), clip_mut_returns_none_for_an_unknown_id() (+22 more)

### Community 5 - "Preview"
Cohesion: 0.08
Nodes (24): AppSink, BoolError, Preview, PreviewError, Display, Error, Formatter, Option (+16 more)
...
Cohesion: 0.07
Nodes (29): extract_first_json_object(), LoudnessError, LoudnormReport, measure_loudness(), parse_loudnorm_stderr(), Display, Error, Formatter (+21 more)
...
- **Why does `OcaApp` connect `OcaApp` to `Project`, `app_test.rs`, `Preview`, `widgets.rs`, `i18n.rs`, `MediaAsset`?**
