...
## Corpus Check
- 282 files · ~381,519 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3829 nodes · 7623 edges · 236 communities (204 shown, 32 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 434 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `400422f8`
...
Cohesion: 0.25
Nodes (16): format_timecode(), MediaAsset, Option, String, Vec, cache_dir_for_project(), materialize_inner(), materialize_nested_sequences() (+8 more)
...
Cohesion: 0.12
Nodes (21): AtomicBool, Display, Error, FnMut, Formatter, From, Option, Path (+13 more)
...
### Community 58 - "App"
Cohesion: 0.07
Nodes (12): text_clip(), TextClip, text_clip(), App, frozen_playhead(), Context, IntoIterator, Item (+4 more)
...
Cohesion: 0.18
Nodes (33): Canvas, ClipSegment, GpuEncoderPreference, apply_audio_mix_pass(), apply_export_aspect_ratio(), apply_shape_overlay_pass(), apply_text_overlay_pass(), clip_segment_duration_secs() (+25 more)
...
Cohesion: 0.20
Nodes (20): ShapeSegment, resolve_shape_segments(), resolve_text_segments(), shape_clip_to_segment(), cancelling_mid_render_reports_cancelled(), fixture(), rejects_a_missing_source(), renders_and_normalizes_loudness_toward_target() (+12 more)
...
Cohesion: 0.14
Nodes (31): Box, AudioSegment, PathBuf, String, TextOverlaySegment, ExportJob, ExportJobStatus, String (+23 more)
...
### Community 86 - "Locale"
Cohesion: 0.17
Nodes (20): Recency, builder(), default_builder(), locale_code(), Arc, Mutex, Option, seed_error_reporting() (+12 more)

### Community 87 - "core/src/lib.rs"
Cohesion: 0.06
Nodes (43): bundled_resource_path(), bundled_resources_dir(), BundledResource, configure_bundled_runtime(), MissingBundleResources, resource_path_in(), resources_dir_for_executable(), Display (+35 more)
...
Cohesion: 0.15
Nodes (27): LoudnessMetrics, AutoReframeEvent, AvailableUpdate, BindableAction, MatteGenerationEvent, MotionTrackRegionState, prefs_path(), RenderEvent (+19 more)
...
Cohesion: 0.08
Nodes (23): enum_combo(), Fn, String, T, Ui, card_frame(), Frame, open_in_finder() (+15 more)
...
### Community 134 - "ErrorReportBuilder"
Cohesion: 0.14
Nodes (12): Breadcrumb, ClipCountBucket, ErrorReportBuilder, ExportStage, MediaContext, ResolutionBucket, Option, Self (+4 more)
...
Cohesion: 0.13
Nodes (23): ColorFilter, color_filter_label(), f32_keyframe_editor(), mask_shape_label(), polygon_vertex_editor(), position_keyframe_editor(), Option, String (+15 more)
...
### Community 164 - "RenderControl"
Cohesion: 0.14
Nodes (6): Condvar, App, RenderControl, AtomicBool, Mutex, MutexGuard
...
Cohesion: 0.17
Nodes (18): contains_forbidden_content(), field_nonempty_ok(), id_ok(), is_known_state_transition(), next_id_hex(), QueueEnvelope, ReportValidationError, Display (+10 more)
...
Cohesion: 0.09
Nodes (9): ClipFormatting, LayerTemplate, Marker, MaskShape, MulticamGroup, HashMap, String, Vec (+1 more)
...
### Community 210 - "ErrorReport"
Cohesion: 0.20
Nodes (12): ErrorCode, ErrorReport, ErrorReporter, ErrorSeverity, NullReporter, Operation, RecoveryOutcome, CapturingReporter (+4 more)
...
### Community 223 - "sanitize_text"
Cohesion: 0.22
Nodes (10): default_environment(), floor_char_boundary(), format_ffmpeg_version(), sanitize_stack_trace(), sanitize_text(), sanitizer_caps_pathological_inputs_before_scanning(), sanitizer_is_idempotent(), sanitizer_removes_every_forbidden_input() (+2 more)
...
### Community 231 - "core/tests/probe_test.rs"
Cohesion: 0.36
...
### Community 235 - "SilenceReview"
Cohesion: 0.67
Nodes (3): Vec, SilenceReview, SilenceReviewGap

## Knowledge Gaps
- **493 isolated node(s):** `App`, `App`, `App`, `SequenceTabDrag`, `TrimEdge` (+488 more)
...
- **Why does `App` connect `App` to `Sequence`, `MediaAsset`, `next_clip_id`, `editor/mod.rs`, `LibraryTrack`, `transcript_proposals_test.rs`, `media.rs`, `Option`, `RenderControl`, `Project`, `ClipInstance`, `PrefsState`, `timeline.rs`, `ExportJob`, `ErrorReport`, `Locale`, `app/mod.rs`, `App`, `SilenceReview`?**
  _High betweenness centrality (0.146) - this node is a cross-community bridge._
- **Why does `ClipInstance` connect `ClipInstance` to `persistence_test.rs`, `timeline_test.rs`, `Preview`, `properties_panel`, `track_with`, `next_clip_id`, `Track`, `src/highlight_detection.rs`, `timeline_window_test.rs`, `transcript_proposals_test.rs`, `timeline_export_multi_test.rs`, `timeline_with`, `Keyframe`, `App`, `probe_media`, `render.rs`, `App`, `silence_detection.rs`, `timeline.rs`, `Position`, `nested_sequence_test.rs`, `preview_test.rs`, `draw.rs`, `App`, `test_track`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `persistence_test.rs`, `app_test.rs`, `transcript.rs`, `App`, `test_asset`, `Sequence`, `test_project`, `ensure_proxy`, `MediaAsset`, `test_track`, `src/background_removal.rs`, `CollabBundleError`, `project_test.rs`, `Locale`, `PrefsState`, `media.rs`, `tests/background_removal_test.rs`?**
  _High betweenness centrality (0.089) - this node is a cross-community bridge._
- **What connects `App`, `App`, `App` to the rest of the system?**
