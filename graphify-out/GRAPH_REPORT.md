...
## Corpus Check
- 271 files · ~354,240 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3545 nodes · 7141 edges · 233 communities (199 shown, 34 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 428 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f5e3f711`
...
Cohesion: 0.16
Nodes (30): AppSrc, AtomicI32, attach_audio_mix_branch(), build_chroma_key_element(), build_composite_branch(), build_mask_shape_stage(), build_static_overlay_branch(), build_uri_decodebin() (+22 more)
...
Cohesion: 0.24
Nodes (12): cache_dir_for_project(), ensure_proxy(), PreviewQuality, proxy_path_for(), ProxyError, Display, Error, Formatter (+4 more)
...
Cohesion: 0.06
Nodes (9): ClipFormatting, ClipInstance, ColorFilter, LayerTemplate, MaskShape, String, Vec, WordTiming (+1 more)

### Community 43 - "Preview"
Cohesion: 0.10
Nodes (26): AppSink, BoolError, AudioLevel, build_audio_filter_bin(), build_audio_mix_output(), build_metering_audio_sink(), CompositeBranch, Preview (+18 more)
...
Cohesion: 0.06
Nodes (35): Box, Condvar, every_preset_has_a_distinct_non_empty_label(), every_preset_targets_the_vertical_aspect_ratio(), ExportJob, ExportJobStatus, PlatformExportPreset, String (+27 more)
...
Cohesion: 0.14
Nodes (32): AutoReframeEvent, AutoReframeState, AvailableUpdate, BindableAction, EditorTool, MatteGenerationEvent, MatteGenerationState, MotionTrackingState (+24 more)
...
Cohesion: 0.18
Nodes (16): TransitionType, color_filter_label(), f32_keyframe_editor(), mask_shape_label(), polygon_vertex_editor(), position_keyframe_editor(), Option, String (+8 more)
...
Cohesion: 0.12
Nodes (6): Marker, MulticamGroup, HashMap, Option, Timeline, Track
...
### Community 152 - "Primary concepts"
Cohesion: 0.14
Nodes (13): Clip, Domain rules, Effect / Transition, Inspector, Keyframe, Media Asset, Playhead, Preview (+5 more)
...
Cohesion: 0.21
Nodes (12): ImportEvent, ImportState, MotionTrackEvent, PreviewState, HashMap, HashSet, TextureHandle, ThumbnailKey (+4 more)
...
### Community 184 - "Layers"
Cohesion: 0.18
Nodes (10): Application services, Architecture, Async work, Commands, Dependency direction, Domain, Layers, Rendering/cache (+2 more)
...
Cohesion: 0.20
Nodes (9): Borders and shadows, Color, Design System, Hierarchy, Icons, Personality, Spacing, States (+1 more)
...
### Community 206 - "next_clip_id"
Cohesion: 0.38
Nodes (4): TrackKind, next_clip_id(), resolve_or_create_track(), Option

### Community 207 - "import.rs"
Cohesion: 0.33
Nodes (8): downscale_rgba(), extract_thumbnail(), import_one(), Option, Path, PathBuf, UnboundedSender, Vec

### Community 208 - "App"
Cohesion: 0.36
Nodes (3): App, Context, ThumbnailKey
...
Cohesion: 0.25
Nodes (7): Before changing UI, Design before code, Done criteria, Mandatory priorities, Non-negotiable UI principles, Project Instructions, Rust principles

### Community 212 - "Timeline Domain and Interaction Rules"
Cohesion: 0.25
Nodes (7): Coordinate systems, Core interactions, Dragging, Selection, Snapping, Timeline Domain and Interaction Rules, Zoom

### Community 213 - "Timeline Performance"
Cohesion: 0.25
Nodes (7): Caching, Frame budget, Hot path rules, Interaction, Level of detail, Timeline Performance, Viewport culling

### Community 215 - "egui Implementation Guide"
Cohesion: 0.29
Nodes (7): Custom widgets, egui Implementation Guide, Input, Layout, Repaint, State, Structure

### Community 216 - "Core Workflows"
Cohesion: 0.29
Nodes (6): Clip editing, Core Workflows, Export, Import to timeline, Playback, Property editing

### Community 217 - "tests/proxy_test.rs"
Cohesion: 0.38
...
## Knowledge Gaps
- **411 isolated node(s):** `App`, `App`, `SequenceTabDrag`, `TrimEdge`, `name` (+406 more)
...
- **Why does `ClipInstance` connect `ClipInstance` to `timeline_test.rs`, `src/preview.rs`, `properties_panel`, `track_with`, `App`, `Timeline`, `src/highlight_detection.rs`, `timeline_window_test.rs`, `transcript_proposals_test.rs`, `Preview`, `timeline_export_multi_test.rs`, `timeline_with`, `Keyframe`, `App`, `probe_media`, `render.rs`, `App`, `Position`, `nested_sequence_test.rs`, `preview_test.rs`, `draw.rs`, `App`, `silence_detection.rs`, `test_track`?**
  _High betweenness centrality (0.155) - this node is a cross-community bridge._
- **Why does `App` connect `App` to `app/mod.rs`, `render.rs`, `App`, `Project`, `UndoStack`, `ClipInstance`, `MediaAsset`, `next_clip_id`, `LibraryTrack`, `PathBuf`, `ExportJob`, `Locale`, `silence_detection.rs`, `PrefsState`, `SmartBin`, `ImportEvent`, `transcript_proposals_test.rs`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `persistence_test.rs`, `app_test.rs`, `transcript.rs`, `App`, `test_asset`, `test_project`, `ensure_proxy`, `MediaAsset`, `test_track`, `Timeline`, `src/background_removal.rs`, `Locale`, `project_test.rs`, `PrefsState`, `SmartBin`?**
