...
## Corpus Check
- 149 files · ~184,534 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1924 nodes · 3784 edges · 95 communities (88 shown, 7 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 240 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d0c5474`
...
Cohesion: 0.15
Nodes (24): from_ocproj_bytes(), load_project_from_file(), PersistError, Display, Error, Formatter, Path, Result (+16 more)
...
### Community 51 - "Locale"
Cohesion: 0.08
Nodes (42): Recency, Screen, job(), job_detail_line_flips_the_negative_lufs_sign_for_display(), job_detail_line_shows_translated_error_prefix_on_failure(), job_detail_line(), job_status_label(), Locale (+34 more)
...
Cohesion: 0.06
Nodes (91): Canvas, ClipSegment, GpuEncoderPreference, PathBuf, String, ShapeSegment, TextSegment, ExportJob (+83 more)
...
Cohesion: 0.22
Nodes (10): Project, Option, PathBuf, String, Vec, new_sequence_appends_and_switches_to_it(), new_sequence_ids_keep_increasing_after_multiple_calls(), test_project() (+2 more)
...
### Community 77 - "MediaAsset"
Cohesion: 0.06
Nodes (49): format_timecode(), MediaAsset, MediaKind, Option, PathBuf, String, Vec, probe_media() (+41 more)

### Community 78 - "tests/background_removal_test.rs"
Cohesion: 0.32
...
- **Why does `App` connect `App` to `PrefsState`, `Project`, `preview_test.rs`, `timeline.rs`, `.new`, `app/mod.rs`, `LibraryTrack`, `ClipInstance`, `App`, `record_event`, `Locale`, `TranscribeEvent`, `src/youtube_download.rs`, `render.rs`, `Position`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `ClipInstance` connect `ClipInstance` to `timeline_test.rs`, `preview_test.rs`, `timeline.rs`, `App`, `test_project`, `App`, `track_with`, `MediaAsset`, `App`, `Keyframe`, `test_asset`, `render.rs`, `Position`, `timeline_panel.rs`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `Project` connect `Project` to `persistence_test.rs`, `app_test.rs`, `test_project`, `App`, `.new`, `ensure_proxy`, `MediaAsset`, `tests/background_removal_test.rs`, `Timeline`, `src/background_removal.rs`, `test_asset`, `Locale`, `parsing.rs`, `render.rs`?**
