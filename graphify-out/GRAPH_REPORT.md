...
## Corpus Check
- 77 files · ~79,957 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 992 nodes · 1950 edges · 51 communities (50 shown, 1 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e1108a2d`
...
### Community 0 - "OcaApp"
Cohesion: 0.07
Nodes (13): OcaApp, AtomicBool, FnOnce, HashMap, TextureHandle, Ui, show(), Ui (+5 more)
...
### Community 36 - "app.rs"
Cohesion: 0.18
Nodes (15): Arc, autosave_is_newer(), downscale_rgba(), extract_thumbnail(), import_one(), ImportEvent, PrefsState, RenderEvent (+7 more)
...
### Community 38 - ".ui"
Cohesion: 0.17
Nodes (8): load_prefs(), prefs_path(), Context, Frame, Self, Ui, sentinel_path(), CreationContext
...
Cohesion: 0.09
Nodes (41): Canvas, Sequence, apply_export_aspect_ratio(), ExportAspectRatio, fps_to_rational(), render_export(), render_export_job(), render_timeline_export() (+33 more)
...
- **Why does `OcaApp` connect `OcaApp` to `Project`, `app_test.rs`, `editor.rs`, `app.rs`, `Preview`, `theme.rs`, `.active_project`, `.add_and_open_project`, `.active_project_mut`, `ClipInstance`, `.ui`, `i18n.rs`, `ExportJob`, `nav_rail.rs`, `render.rs`?**
  _High betweenness centrality (0.249) - this node is a cross-community bridge._
- **Why does `test_app()` connect `app_test.rs` to `OcaApp`, `Project`, `test_project`, `ExportJob`, `test_canvas`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `ClipInstance` connect `ClipInstance` to `OcaApp`, `editor.rs`, `timeline_test.rs`, `Preview`, `.active_project`, `test_project`, `track_with`, `render.rs`?**
