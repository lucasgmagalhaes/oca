# Graph Report - hungry-leakey-000d88  (2026-08-12)

## Corpus Check
- 71 files · ~69,066 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 889 nodes · 1641 edges · 47 communities (45 shown, 2 thin omitted)
...
Cohesion: 0.11
Nodes (6): ClipInstance, Option, String, Track, test_clip(), test_composite_clip()
...
- **Why does `OcaApp` connect `OcaApp` to `app_test.rs`, `editor.rs`, `app.rs`, `Preview`, `i18n.rs`, `Option`, `.active_project`, `.create_new_project`, `ClipInstance`, `.ui`, `Project`, `timeline.rs`?**
