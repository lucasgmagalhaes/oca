...
//! ([`probe`], [`loudness`]), lightweight editing proxies ([`proxy`]), JSON save/load
//! ([`persistence`]), and mock data for exercising the UI before those wrappers are wired
//! into it end-to-end ([`sample`]).
//!
