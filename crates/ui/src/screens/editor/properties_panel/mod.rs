                ...
                egui::ScrollArea::vertical()
                    ...
                    .show(ui, |ui| {
                        ...
                        if let Some(clip) = app.selected_clip() {
                            ...
                            let mut voice_cleanup_noise_floor_db =
                                clip.voice_cleanup_noise_floor_db;
                            ...
                            let mut voice_cleanup_ceiling_linear =
                                clip.voice_cleanup_ceiling_linear;
                                        ...
                                        if voice_cleanup_enabled {
                                            ...
                                            changed |= ui
                                                .add(
                                                    ...
                                                    .suffix(":1")
                                                    .text(
                                                        Text::VoiceCleanupCompressorRatio
                                                            .tr(locale),
                                                    ),
                                                )
                                                .changed();
                                ...
                                == Some(avcore::timeline::TrackKind::Video)
                            {
                                        ...
                                        |ui| {
                                            ...
                                            ui.horizontal(|ui| {
                                                ...
                                                if ui
                                                    ...
                                                    .on_hover_text(
                                                        Text::DynamicReframeHint.tr(locale),
                                                    )
                                                    .clicked()
                                                {
                                ...
                                if tab == crate::app::PropertiesTab::Effects {
                                        ...
                                        |ui| {
                                            ...
                                            ui.horizontal(|ui| {
                                                ...
                                                if !lut_path.is_empty()
                                                    && ui
                                                        .button(Text::ClearLut.tr(locale))
                                                        .clicked()
                                                {
                                                    lut_path.clear();
                                                    changed = true;
                                    ...
                                    if stabilization_changed {
                                        app.set_selected_clip_stabilization(
                                            stabilization_intensity,
                                        );
                                    }
                                ...
                                if tab == crate::app::PropertiesTab::Inspector {
                                            ...
                                            |ui| {
                                                ui.add_enabled_ui(!tracking, |ui| {
                                                    ...
                                                    ui.add(
                                                        ...
                                                        .text(
                                                            Text::PropMotionTrackHeight.tr(locale),
                                                        ),
                                                    );
                                                    ui.add(
                                                egui::Slider::new(
                                    ...
                                    let anchor_changed = components::property_section(
                                        ...
                                        (anchor_x - 0.5).abs() > 1e-4
                                            || (anchor_y - 0.5).abs() > 1e-4,
                                        |ui| {
                                            let mut changed = false;
                                            changed |= ui
                                                .add(
